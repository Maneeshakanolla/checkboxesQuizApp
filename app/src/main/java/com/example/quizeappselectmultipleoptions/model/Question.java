package com.example.quizeappselectmultipleoptions.model;
...
public class Question {
    ...
    @SerializedName("correct_option1")
    @Expose
    private String correctOption1;
    @SerializedName("correct_option2")
    @Expose
    ...
    public void setCorrectOption1(String correctOption1) {
